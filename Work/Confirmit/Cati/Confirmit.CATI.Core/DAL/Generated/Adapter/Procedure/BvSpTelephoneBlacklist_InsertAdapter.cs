...
{
    public class BvSpTelephoneBlacklist_InsertAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpTelephoneBlacklist_Insert";
            ...
            command.Parameters.Add(new SqlParameter("@Comment", SqlDbType.VarChar)).Value = (object)Comment ?? DBNull.Value;
