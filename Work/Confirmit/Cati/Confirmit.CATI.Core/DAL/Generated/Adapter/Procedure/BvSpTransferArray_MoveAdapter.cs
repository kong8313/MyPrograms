...
{
    public class BvSpTransferArray_MoveAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpTransferArray_Move";
            ...
            command.Parameters.Add(new SqlParameter("@srcBatchId", SqlDbType.Int)).Value = (object)srcBatchId ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@dstBatchId", SqlDbType.Int)).Value = (object)dstBatchId ?? DBNull.Value;
