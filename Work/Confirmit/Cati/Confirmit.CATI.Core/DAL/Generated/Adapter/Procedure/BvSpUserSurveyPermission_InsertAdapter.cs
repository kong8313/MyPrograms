...
{
    public class BvSpUserSurveyPermission_InsertAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpUserSurveyPermission_Insert";
            ...
            command.Parameters.Add(new SqlParameter("@SurveyName", SqlDbType.NVarChar)).Value = (object)SurveyName ?? DBNull.Value;
