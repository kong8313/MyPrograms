...
{
    public class BvSpTasks_UpdateProblemStateAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpTasks_UpdateProblemState";
            ...
            command.Parameters.Add(new SqlParameter("@ProblemId", SqlDbType.Int)).Value = (object)ProblemId ?? DBNull.Value;
