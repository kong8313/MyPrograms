...
{
    public class BvSpCleanMessagesAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpCleanMessages";
            ...
            command.Parameters.Add(new SqlParameter("@ExpirationPeriod", SqlDbType.Int)).Value = (object)ExpirationPeriod ?? DBNull.Value;
