...
{
    public class BvSpCreateTransferBatchIDAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpCreateTransferBatchID";
            ...
            command.Parameters.Add(new SqlParameter("@bibb", SqlDbType.Int)).Value = (object)bibb ?? DBNull.Value;
