...
{
    public class BvSpAsyncOperationQueue_AppendTextAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpAsyncOperationQueue_AppendText";
            ...
            command.Parameters.Add(new SqlParameter("@Text", SqlDbType.NVarChar)).Value = (object)Text ?? DBNull.Value;
