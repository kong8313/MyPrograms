...
{
    public class BvSpStateGroup_InsertAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpStateGroup_Insert";
            ...
            command.Parameters.Add(new SqlParameter("@CopyID", SqlDbType.Int)).Value = (object)CopyID ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@Name", SqlDbType.VarChar)).Value = (object)Name ?? DBNull.Value;
