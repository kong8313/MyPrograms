...
{
    public class BvSpShiftType_GetIDAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpShiftType_GetID";
            ...
            command.Parameters.Add(new SqlParameter("@OwnerID", SqlDbType.Int)).Value = (object)OwnerID ?? DBNull.Value;
