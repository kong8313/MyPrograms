...
{
    public class BvSpQueueUpSheduleTask3Adapter
    {
        
        public static SqlCommand CreateCommand(
                DateTime? NowUTC,
                int? DefaultTZ,
                int? TzBalancingThreshold,
                int? commandExecutionTimeout)
        {
            var command = new SqlCommand(); 
            
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "BvSpQueueUpSheduleTask3";
            ...
            command.Parameters.Add(new SqlParameter("@NowUTC", SqlDbType.DateTime)).Value = (object)NowUTC ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@DefaultTZ", SqlDbType.Int)).Value = (object)DefaultTZ ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@TzBalancingThreshold", SqlDbType.Int)).Value = (object)TzBalancingThreshold ?? DBNull.Value;
