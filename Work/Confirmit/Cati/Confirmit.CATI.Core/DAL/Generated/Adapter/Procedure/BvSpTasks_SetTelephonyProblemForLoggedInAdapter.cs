...
{
    public class BvSpTasks_SetTelephonyProblemForLoggedInAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpTasks_SetTelephonyProblemForLoggedIn";
            ...
            command.Parameters.Add(new SqlParameter("@ProblemCode", SqlDbType.Int)).Value = (object)ProblemCode ?? DBNull.Value;
