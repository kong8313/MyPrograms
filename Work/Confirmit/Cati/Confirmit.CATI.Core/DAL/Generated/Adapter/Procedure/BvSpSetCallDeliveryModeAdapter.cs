...
{
    public class BvSpSetCallDeliveryModeAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpSetCallDeliveryMode";
            ...
            command.Parameters.Add(new SqlParameter("@Mode", SqlDbType.Bit)).Value = (object)Mode ?? DBNull.Value;
