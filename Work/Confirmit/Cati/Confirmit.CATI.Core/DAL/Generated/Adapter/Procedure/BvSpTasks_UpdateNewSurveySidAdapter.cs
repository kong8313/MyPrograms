...
{
    public class BvSpTasks_UpdateNewSurveySidAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpTasks_UpdateNewSurveySid";
            ...
            command.Parameters.Add(new SqlParameter("@NewSurveySID", SqlDbType.Int)).Value = (object)NewSurveySID ?? DBNull.Value;
