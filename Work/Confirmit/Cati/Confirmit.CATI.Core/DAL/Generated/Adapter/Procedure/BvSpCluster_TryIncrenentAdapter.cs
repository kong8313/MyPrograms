...
{
    public class BvSpCluster_TryIncrenentAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpCluster_TryIncrenent";
            ...
            command.Parameters.Add(new SqlParameter("@Force", SqlDbType.Bit)).Value = (object)Force ?? DBNull.Value;
