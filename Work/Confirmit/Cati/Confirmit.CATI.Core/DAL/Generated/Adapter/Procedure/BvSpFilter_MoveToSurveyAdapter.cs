...
{
    public class BvSpFilter_MoveToSurveyAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpFilter_MoveToSurvey";
            ...
            command.Parameters.Add(new SqlParameter("@SourceSurveySid", SqlDbType.Int)).Value = (object)SourceSurveySid ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@TargetSurveySid", SqlDbType.Int)).Value = (object)TargetSurveySid ?? DBNull.Value;
