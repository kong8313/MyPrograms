...
{
    public class BvSpCleanDeferredMonitoringAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpCleanDeferredMonitoring";
            ...
            command.Parameters.Add(new SqlParameter("@ExpirationPeriodInDays", SqlDbType.Int)).Value = (object)ExpirationPeriodInDays ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@DeleteTopRows", SqlDbType.Int)).Value = (object)DeleteTopRows ?? DBNull.Value;
