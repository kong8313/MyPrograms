...
{
    public class BvSpUserSurveyList_CleanAdapter
    {
        
        public static SqlCommand CreateCommand(
                DateTime? MaxAddedTime,
                int? commandExecutionTimeout)
        {
            var command = new SqlCommand(); 
            
            command.CommandType = CommandType.StoredProcedure;
            command.CommandText = "BvSpUserSurveyList_Clean";
            ...
            command.Parameters.Add(new SqlParameter("@MaxAddedTime", SqlDbType.DateTime)).Value = (object)MaxAddedTime ?? DBNull.Value;
