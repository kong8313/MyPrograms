...
{
    public class BvSpFilter_CheckSurveyMismatchAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpFilter_CheckSurveyMismatch";
            ...
            command.Parameters.Add(new SqlParameter("@SubFilterSID", SqlDbType.Int)).Value = (object)SubFilterSID ?? DBNull.Value;
