...
{
    public class BvSpMembership_DeleteAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpMembership_Delete";
            ...
            command.Parameters.Add(new SqlParameter("@ContainerSID", SqlDbType.Int)).Value = (object)ContainerSID ?? DBNull.Value;
