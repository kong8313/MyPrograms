...
{
    public class BvSpGetLiveShiftsAdapter
    {
                ...
                int? commandExecutionTimeout)
        {
            ...
            command.CommandText = "BvSpGetLiveShifts";
            ...
            command.Parameters.Add(new SqlParameter("@utc", SqlDbType.SmallDateTime)).Value = (object)utc ?? DBNull.Value;
            command.Parameters.Add(new SqlParameter("@tz_local", SqlDbType.Int)).Value = (object)tz_local ?? DBNull.Value;
