...
{
    public class SupervisorServiceChannelFactoryWrapperConfiguration : IChannelFactoryWrapperConfiguration 
    {
        ...
        public string EndpointConfigurationName
        {
            get
            {
                return "SupervisorServiceEndpoint";
            }
        }
        ...
        public string AdjustEndpointUri(string originalUrl)
        {
            ...
            {
                originalUrl = originalUrl.Replace("/localhost/", $"/cati-backend-{companyId}/");
            }
            
            return ServiceLocator.Resolve<ISideBySideManager>().AddSideBySideNameToBackendWCFServiceUrl(originalUrl) + companyId;
        }
        ...
        public IEnumerable<IEndpointBehavior> EndpointBehaviors
        {
            get
            {
                return new SupervisorMessageHeaderBehavior().CreateArray();
            }
        }
