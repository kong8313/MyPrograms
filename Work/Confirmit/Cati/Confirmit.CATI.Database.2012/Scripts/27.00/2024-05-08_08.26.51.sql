GO
PRINT N'Add InterviewerPassword.IsChangeAfterFirstLoginRequired system setting';
...
GO
PRINT N'Altering InterviewerPassword.IsResetToSamePasswordEnabled setting values';

UPDATE BvSystemSettings SET [Value] = 'False' WHERE [SystemName] = 'InterviewerPassword.IsResetToSamePasswordEnabled' 
...
ALTER TABLE [dbo].[BvPerson]
    ADD [PasswordNeedsChange] BIT CONSTRAINT [DF_BvPerson_PasswordNeedsChange] DEFAULT (0) NOT NULL;
