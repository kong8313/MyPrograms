...
ALTER TABLE [dbo].[BvSurvey]
    ADD [InboundCallBehavior] TINYINT CONSTRAINT [DF_BvSurvey_InboundCallBehavior] DEFAULT (0) NOT NULL;


GO
UPDATE [BvSurvey] SET [InboundCallBehavior] = [IsRespondentsDynamicCreationAllowed];
