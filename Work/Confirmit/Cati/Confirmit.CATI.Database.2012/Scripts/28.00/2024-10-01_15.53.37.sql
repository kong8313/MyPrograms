...
CREATE TABLE [dbo].[tmp_ms_xx_BvInterviewerProductivityReportTemplate] (
    ...
    [SplitBySurvey]                  BIT            NOT NULL CONSTRAINT tmp_ms_xx_constraint_DF_BvInterviewerProductivityReportTemplate_SplitBySurvey DEFAULT 0,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_BvInterviewerProductivityReportTemplate] ([Id], [Name], [DateCreated], [CreatorName], [CreatorLogin], [LastModified], [AccessType], [IsPortrait], [IsDefault], [IncludeZeroValues], [ShowDialerAttempts], [IncludeBreakTimeInCalculations], [ColumnData])
        SELECT   [Id],
                 [Name],
                 [DateCreated],
                 [CreatorName],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_DF_BvInterviewerProductivityReportTemplate_SplitBySurvey]', N'DF_BvInterviewerProductivityReportTemplate_SplitBySurvey', N'OBJECT';
