PRINT N'adding new column to BvSurvey'
ALTER TABLE [BvSurvey] ADD [SurveySqlServerName] nvarchar(255) NULL CONSTRAINT ServerDefaultValue DEFAULT '';
GO

PRINT N'cleanup contraint in BvSurvey'
ALTER TABLE [BvSurvey] DROP CONSTRAINT ServerDefaultValue
GO

PRINT N'Updating BvSpSurvey_Insert procedure'
GO
