...
ALTER TABLE [dbo].[BvTimeBreaksHistory]
    ADD [SurveyId] INT CONSTRAINT [DF_BvTimeBreaksHistory_SurveyId] DEFAULT (0) NOT NULL;
...
AS 
 ...
 (
    ...
    WHERE StartTime BETWEEN @StartDateTime AND @EndDateTime AND ( s.SurveyId IS NOT NULL OR @CalcAllBreakHistory = 1 )
...
BEGIN
	...
	INSERT INTO BvTimeBreaksHistory (InterviewerId, StartTime, CallCenterId, SurveyId) VALUES (@InterviewerId, GETUTCDATE(), @CallCenterId, @SurveyId)
END
GO
