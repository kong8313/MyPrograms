...
ALTER TABLE [dbo].[BvDialers]
    ADD [IsActive]     BIT CONSTRAINT [DF_BvDialers_IsActive] DEFAULT (1) NOT NULL,
...
GO
PRINT N'Creating [dbo].[BvSpGetNextAvailableDialer]...';
...
BEGIN
       ...
       BEGIN
              ...
              UPDATE BvSurvey SET DialerId = @dialerid
       end
