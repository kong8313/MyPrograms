...
ALTER TABLE [dbo].[BvSurvey]
    ADD [IsQuotaInCatiDb] BIT NULL;


GO
PRINT N'Creating [dbo].[BvSurveyQuota]...';
...
GO
PRINT N'Creating [dbo].[BvSurveyQuotaCell]...';
...
GO
PRINT N'Creating [dbo].[FK_BvSurveyQuota_Survey]...';


GO
ALTER TABLE [dbo].[BvSurveyQuota] WITH NOCHECK
    ADD CONSTRAINT [FK_BvSurveyQuota_Survey] FOREIGN KEY ([SurveyID]) REFERENCES [dbo].[BvSurvey] ([SID]) ON DELETE CASCADE;
...
GO
ALTER TABLE [dbo].[BvSurveyQuota] WITH CHECK CHECK CONSTRAINT [FK_BvSurveyQuota_Survey];
