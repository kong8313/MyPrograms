...
ALTER TABLE [dbo].[BvSurvey]
    ADD [IsRespondentsDynamicCreationAllowed] BIT CONSTRAINT [DF_BvSurvey_IsRespondentsDynamicCreationAllowed] DEFAULT (0) NOT NULL;
...
GO
PRINT N'Droping [dbo].[BvSpCall_GetFreshSampleWithEmptyTelNumber]...';


GO
DROP PROCEDURE [dbo].[BvSpCall_GetFreshSampleWithEmptyTelNumber]
...
GO
PRINT N'Refreshing [dbo].[BvSpSvyShedule_DeleteCallsByBlacklist]...';
