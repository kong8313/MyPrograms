...
namespace Confirmit.CATI.IntegrationTests.XUnit.Tests.Scheduling
{
    ...
    public sealed class ScriptIsAnyoneLoggedIntoSurvey : BaseMockedIntegrationTest
    {
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsAnyoneLoggedIntoSurvey_PersonNotLoggedIn_SubruleIsNotExecuted(SecurityMode mode)
        {
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsAnyoneLoggedIntoSurvey()", true),
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsAnyoneLoggedIntoSurvey_PersonIsLoggedIn_SubruleIsExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsAnyoneLoggedIntoSurvey_AutomaticPersonIsLoggedIntoDifferentSurvey_SubruleIsExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsAnyoneLoggedIntoSurvey_SurveySelectionPersonIsLoggedIntoDifferentSurvey_SubruleIsNotExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
