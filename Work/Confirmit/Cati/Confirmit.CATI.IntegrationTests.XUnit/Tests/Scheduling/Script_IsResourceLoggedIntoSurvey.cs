...
namespace Confirmit.CATI.IntegrationTests.XUnit.Tests.Scheduling
{
    ...
    public sealed class ScriptIsResourceLoggedIntoSurvey : BaseMockedIntegrationTest
    {
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_PersonNotLoggedIn_SubruleIsNotExecuted(SecurityMode mode)
        {
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsResourceLoggedIntoSurvey({notExistedPersonOrGroupId})", true),
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_PersonIsLoggedIn_SubruleIsExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsResourceLoggedIntoSurvey({personId})", true),
                            new SubRule(new Action(Action.Operation.SetNewITS, "32"))
                        },
                        new Shift(1, 1, "0.00:00:00", "6.23:59:59"))
                    }
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_NoLoggedPersonsInPersonGroup_SubruleIsNotExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsResourceLoggedIntoSurvey({groupId})", true),
                            new SubRule(new Action(Action.Operation.SetNewITS, "32"))
                        },
                        new Shift(1, 1, "0.00:00:00", "6.23:59:59"))
                    }
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_OneLoggedPersonInPersonGroup_SubruleIsExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_OneLoggedPersonInDifferentPersonGroup_SubruleIsNotExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsResourceLoggedIntoSurvey({group2Id})", true),
                            new SubRule(new Action(Action.Operation.SetNewITS, "32"))
                        },
                        new Shift(1, 1, "0.00:00:00", "6.23:59:59"))
                    }
        ...
        [Theory, Owner(@"FIRM\grigoryk")]
        [ClassData(typeof(TestDataGenerator))]
        public void IsResourceLoggedIn_SurveySelectionPersonIsLoggedIntoDifferentSurvey_SubruleIsNotExecuted(SecurityMode mode)
        {
            SetSecurityMode(mode);
            ...
            var context = new TestData
            {
                ...
                Scripts = new[] {
                    new ScriptData { Tag="SS1", Script = new TestScript(new [] {
                            new SubRule(new Action(Action.Operation.SetNewITS, "31"), (int)CallOutcome.Appointment, 0, 0, $"IsResourceLoggedIntoSurvey({person2Id})", true),
                            new SubRule(new Action(Action.Operation.SetNewITS, "32"))
                        },
                        new Shift(1, 1, "0.00:00:00", "6.23:59:59"))
                    }
