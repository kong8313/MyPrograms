<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master"
    CodeBehind="ChangeLimitForMultipleQuotas.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Surveys.ChangeLimitForMultipleQuotas" %>
    ...
    <controls:Dialog ID="dialog" runat="server" Mode="Modal" HideHeader="true">
        ...
        <Content>
            <main class="content-panel">
                <controls:Hint ID="Hint" runat="server" />
