<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master"
    CodeBehind="InboundCallSummaryReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.InboundCallSummaryReport"
    ClientIDMode="AutoID" %>
    ...
    <div class="report-panel">
        ...
        <div class="report-panel__content">
            ...
            <div class="report-panel__telerik-area">
                <controls:Hint ID="reportHint" runat="server" Text="<%$CPResource:InboundCallSummaryReportHint %>" />
