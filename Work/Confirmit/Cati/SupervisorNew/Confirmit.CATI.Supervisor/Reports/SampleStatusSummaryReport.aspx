<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master"
    CodeBehind="SampleStatusSummaryReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.SampleStatusSummaryReport"
    ClientIDMode="AutoID" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="Content" runat="server">
    <script type="text/javascript">
        Y.on('load', function () {
            ...
            hideOptions.forEach(function (item) {
                var hiddenOption = document.querySelector('.report-panel__telerik-area option[value="' + item + '"]');
                if (hiddenOption) {
    ...
    <div class="report-panel">
        ...
        <div class="report-panel__content">
                    ...
                    <div class="sidebar__item">
                        ...
                        <div class="flex-panel flex-panel-column">
                            <div class="setting-item">
                                <controls:CheckBox ID="cbxHideZeroStatuses" runat="server" AutoPostBack="false" Checked="true"
            ...
            <div class="report-panel__telerik-area">
                <controls:Hint ID="reportHint" runat="server" Text="<%$CPResource:SampleStatusSummaryReportHint %>" />
