<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master"
    CodeBehind="AttemptsByDispositionReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.AttemptsByDispositionReport"
    ClientIDMode="AutoID" %>
    ...
    <div class="report-panel">
        ...
        <div class="report-panel__content">
            <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always" class="sidebar">
                ...
                <ContentTemplate>
                    ...
                    <div class="sidebar__item">
                        ...
                        <div class="flex-panel flex-panel-column">
                            <controls:CheckBox ID="cbxHideZero" runat="server" AutoPostBack="false" Checked="true"
                                Text="<%$CPResource:HideZeroStatuses%>" />
                        </div>
                    </div>
                    <div class="sidebar__item">
                        <header class="flex-panel flex-panel-row">
            ...
            <div class="report-panel__telerik-area">
                <controls:Hint ID="reportHint" runat="server" Text="<%$CPResource:AttemptsByDispositionReportHint %>" />
