<%@ Page Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="True"
    CodeBehind="NumberOfAttemptsReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.NumberOfAttemptsReport"
    ClientIDMode="AutoID" %>
    ...
    <div class="report-panel">
        ...
        <div class="report-panel__content">
            ...
            <div class="report-panel__telerik-area">
                <controls:Hint ID="reportHint" runat="server" Text="<%$CPResource:NumberOfAttemptsReportHint %>" />
