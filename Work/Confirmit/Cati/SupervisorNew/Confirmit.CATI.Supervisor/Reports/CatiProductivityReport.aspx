<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPages/Main.Master"
    CodeBehind="CatiProductivityReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.CatiProductivityReport"
    ClientIDMode="AutoID" %>
    ...
    <div class="report-panel">
        <div class="report-panel__toolbar">
            ...
            <div class="flex-panel flex-panel-row">
                <controls:DropDownList ID="ddlCustomizationTemplate" runat="server" CssClass="dropdown-select-custom_template" />
                <controls:Button ID="btnBuild" Text="Build report" CssClass="plain_button build-button" runat="server" IsSubmit="true" />
                <controls:ImageButton ID="btnCustomTemplates" runat="server" ToolTip="Manage customizations" IsSubmit="False" Style="margin-left: 10px;"
                    CausesValidation="false" ImageName="properties" />
            </div>
        </div>
        <div class="report-panel__content">
            <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always" class="sidebar">
                ...
                <ContentTemplate>
                    ...
                    <div class="sidebar__item">
                        <header class="flex-panel flex-panel-row">
                            <h4>
                                <controls:SvgImage runat="server" ImageName="persons" Title="<%$CPResource:DatesRange%>" />
                                <%=Strings.Persons%></h4>
            ...
            <div style="visibility: hidden">
                <controls:UpdatePanel ID="updatePanelHidden" runat="server">
