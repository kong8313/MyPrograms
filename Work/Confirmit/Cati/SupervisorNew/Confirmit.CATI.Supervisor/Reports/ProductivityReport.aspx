<%@ Page Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true"
    CodeBehind="ProductivityReport.aspx.cs" Inherits="Confirmit.CATI.Supervisor.Reports.ProductivityReport" %>
        ...
        <div class="report-panel__content">
            <asp:UpdatePanel ID="updatePanel1" runat="server" ChildrenAsTriggers="true" UpdateMode="Always" class="sidebar">
                ...
                <ContentTemplate>
                    ...
                    <div class="sidebar__item" ID="surveysArea" runat="server">
                        <header class="flex-panel flex-panel-row">
                            <h4>
                    ...
                    <div class="sidebar__item" id="varFilter" runat="server">
                     ...
                     <div class="sidebar__item">
                        ...
                        <div class="flex-panel flex-panel-column">
                            <div class="setting-item">
                                <controls:CheckBox ID="cbxIncludePercentage" runat="server" AutoPostBack="false" Checked="false"
                                    Text="<%$CPResource:IncludePercentage%>" />
                            </div>
                        </div>
                    </div>
                </ContentTemplate>
            ...
            <div class="report-panel__telerik-area">
                <controls:Hint ID="reportHint" runat="server" />
