...
namespace Confirmit.CATI.DatabaseUpdateLibraryCore.Interfaces
{
    public interface IQueryExecutor
    {
        ...
        string CreateAdminConnectionString(string databaseName = "master");
        ...
        T ExecuteDataTableNotInTransaction<T>(string databaseName, string query) where T : DataTable, new(); 
    }
}