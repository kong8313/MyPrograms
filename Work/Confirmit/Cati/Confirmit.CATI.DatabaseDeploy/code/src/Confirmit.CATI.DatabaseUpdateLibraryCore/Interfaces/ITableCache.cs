namespace Confirmit.CATI.DatabaseUpdateLibraryCore.Interfaces
{
    public interface ITableCache
    {
        ...
        /// registers cache to be notified after transaction successful commit.
        /// After transaction committed DatabaseTransactionScope will call OnCacheExpired.
        /// 
        /// If called outside transaction (outside DatabaseTransactionScope) then
        /// expires the cache (calls OnCacheExpired immediately.)
        /// </summary>
        void OnTableChanged();
        ...
        /// or from DatabaseTransactionScope after successful commit.
        /// </summary>
        void OnCacheExpired();
    }
}
