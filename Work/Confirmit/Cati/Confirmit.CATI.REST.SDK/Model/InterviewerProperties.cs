...
namespace Confirmit.CATI.REST.SDK.Model
{
    ...
    {
        /// <summary>
        /// Creates and initializes an instance of InterviewerProperties class
        /// </summary>
        public InterviewerProperties()
        {
            ParentGroups = new List<int> {Constants.Constants.CatiInterviewersRootGroupId};

            AllowedTaskChoice = new List<TaskChoicePermissions>();
            CallCenterId = 1;
            Description = "";
            Mode = TaskChoiceMode.SurveyAssignment;
            DialType = DialType.Automatic;
        }
        ...
        /// <summary>
        /// Task choice: manual, automatic, survey assignment and choice. This value is ignored if AllowedTaskChoice is specified.
        /// </summary>
        ...
        /// <summary>
        /// Additional person's attribute 1 
        /// </summary>
        public string Attribute1 { get; set; }
        
        /// <summary>
        /// Additional person's attribute 2 
        /// </summary>
        public string Attribute2 { get; set; }
        
        /// <summary>
        /// Additional person's attribute 3 
        /// </summary>
        public string Attribute3 { get; set; }
        
        /// <summary>
        /// Additional person's attribute 4 
        /// </summary>
        public string Attribute4 { get; set; }
        
        /// <summary>
        /// Additional person's attribute 5 
        /// </summary>
