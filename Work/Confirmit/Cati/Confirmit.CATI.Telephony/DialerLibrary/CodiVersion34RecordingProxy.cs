...
{
    public class CodiVersion34RecordingProxy : ICodiVersionRecordingProxy
    {
        private readonly IChannelFactoryWrapper<IDialerService34> _recordingChannel;

        public CodiVersion34RecordingProxy(IChannelFactoryWrapper<IDialerService34> recordingChannel)
        {
