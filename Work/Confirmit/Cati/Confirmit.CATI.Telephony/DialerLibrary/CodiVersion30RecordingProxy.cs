...
{
    public class CodiVersion30RecordingProxy : ICodiVersionRecordingProxy
    {
        private readonly IChannelFactoryWrapper<IDialerService30> _recordingChannel;

        public CodiVersion30RecordingProxy(IChannelFactoryWrapper<IDialerService30> recordingChannel)
        {
