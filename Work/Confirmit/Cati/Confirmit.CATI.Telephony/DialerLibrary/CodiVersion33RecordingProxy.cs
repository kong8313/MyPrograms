...
{
    public class CodiVersion33RecordingProxy : ICodiVersionRecordingProxy
    {
        private readonly IChannelFactoryWrapper<IDialerService33> _recordingChannel;

        public CodiVersion33RecordingProxy(IChannelFactoryWrapper<IDialerService33> recordingChannel)
        {
