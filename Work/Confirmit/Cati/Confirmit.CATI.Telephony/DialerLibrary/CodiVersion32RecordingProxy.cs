...
{
    public class CodiVersion32RecordingProxy : ICodiVersionRecordingProxy
    {
        private readonly IChannelFactoryWrapper<IDialerService32> _recordingChannel;

        public CodiVersion32RecordingProxy(IChannelFactoryWrapper<IDialerService32> recordingChannel)
        {
