...
namespace Confirmit.CATI.Telephony.DialerService
{
    ...
    public class DialerService : IDialerService, IDisposable, IDialerEvents
    {
        ...
        public DialerService() : this(
            ...
            new NotificationsSenderInitializer(Logger))
        {
        }
            ...
            InterviewStatus currentInterviewStatus, long nextCampaignId, int nextInterviewId, long nextCallId)
        {
            ...
            return Execute(companyId,
                ...
                argumentsAsString,
                requestId => DoDialerCall(
                    () => _bridgeToDialer.SetNextInterview(companyId, dialerId, currentCampaignId, agentId, currentInterviewStatus, nextCampaignId, nextInterviewId, nextCallId), requestId));
        }
        ...
        public void NotifyInboundCall(int companyId, int dialerId, string inboundLinePhoneNumber, string callerPhoneNumber,
            int inboundCallId)
        {
