...
namespace Confirmit.CATI.Telephony.DialerCommon
{
    ...
    /// </summary>
    public class NotificationsSenderInitializer : INotificationsSenderInitializer
    {
        ...
        /// </returns>
        public IDialerEventNotificationsSender InitializeIdentity(int dialerId, int companyId)
        {
