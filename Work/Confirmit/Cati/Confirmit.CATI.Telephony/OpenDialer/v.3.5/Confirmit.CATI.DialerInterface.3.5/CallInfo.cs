...
namespace ConfirmitDialerInterface
{
    ...
    public class CallInfo
    {
        ...
        /// a value of 0 means never and a positive value means the numbere of previous connects,
        /// In predictive mode this value is used in the predictive calling algorithm.
        /// Default value: 0.
        /// </summary>
        [DataMember]
        ...
        public override string ToString()
        {
            return string.Format(
                "CallInfo[agentId={0}, contactId={1}, callId={2}, agentGroupId={3}, phoneNumber={4}, " +
                "timeToCall={5}, diallingMode={6}, wasAbandoned={7}, dialingAttemptsMade={8}, previousConnects={9}, " +
                "numberOfNoAnswer={10}, isRecording={11},  agingTimeout={12}, dialerSpecificAccompanyInfo=({13}), callerId = {14}]",
                ...
                numberOfNoAnswer, isRecording, agingTimeout, dialerSpecificAccompanyInfo, callerId);
        }
    }
}
