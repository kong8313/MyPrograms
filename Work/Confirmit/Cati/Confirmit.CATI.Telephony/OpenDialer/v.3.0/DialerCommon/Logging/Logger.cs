...
namespace Confirmit.CATI.Telephony
{
    public class Logger : ICommonLogger
    {
        ...
        public Logger(string sourceName)
            : this(sourceName, new UtcOffsetSource())
        {
        }
        ...
        public Logger(string sourceName, IUtcOffsetSource utcOffsetSource)
        {
            _utcOffsetString = new UtcOffsetString(utcOffsetSource);
...
// ReSharper restore EmptyGeneralCatchClause
        ...
        {
            return _utcOffsetString + " " + DateTimeAsString() + "\t" + comment + "\t" + message;
        }
