...
using CallsSelectionAlgorithm = ConfirmitDialerInterface.CallsSelectionAlgorithm;
...
{
    public interface IMNTCILibraryEvents
    {
        void OnMNDialerNotifyOutcome(
            int dialerId, 
            string tenantId, 
            long campaignId, 
            long agentId, 
        ...
        void OnMNDialerNotifyAgentState(
            int dialerId, 
            string tenantId,
            long campaignId,
            long agentId,
        ...
        void OnMNDialerUnavailable(int dialerId);

        void OnDialerTrunkLineAlarms(int dialerId, string message);
        ...
        /// </summary>
        void OnMNDialerRestart(int dialerId);
        ...
        void OnMNDialerMonitorStatus(int dialerId, string sessionId, bool isError, int statusCode);
        ...
        /// <summary>
        /// This method is called when dialer had its license expired withing next 10 days.
        /// </summary>
        /// <param name="dialerId"></param>
        /// <param name="licenseExpirationDateTime"></param>
        void OnDialerLicenseExpiration(int dialerId, string licenseExpirationDateTime);
    }

    //TODO: Seems, the interface is not used and could be removed
    public interface IDialerAPI
    {
        int Initialize(
            ...
            IMNTCILibraryEvents ifaceEvents);
        int Release();
        int StartCampaign(string tenantId, long campaignId, string campaignName, DialingMode dialingMode, string campaignType, bool recordWholeInterview, string surveyParametersXml);
        int StopCampaign(string tenantId, long campaignId, DialingMode dialingMode);
        int KillCampaign(string tenantId, long campaignId, DialingMode dialingMode);
        int Login(
            string tenantId, 
            long campaignId, 
            string agentId, 
        ...
        int GoNotReady(string tenantId, long campaignId, string agentId);
        ...
        /// <returns></returns>
        int Redial(string tenantId, long campaignId, string agentId, int contactId, int callId, string phoneNumber, bool isRecording);

        int Hangup(string tenantId, long campaignId, string agentId);

        int CompleteCall(string tenantId, long campaignId, string agentId, bool makeAgentReady);
        ...
        /// </summary>
        /// <param name="tenantId">Confirmit company id</param>
        /// <param name="campaignId">The unique identifier of the Campaign</param>
        /// <param name="agentId">The unique identifier of the Agent.</param>
        ...
        /// <returns>
        /// </returns>
        int FlushNumbers(string tenantId, long campaignId, List<CallInfo> callsList);
       ...
       /// <summary>
        ...
        /// </summary>
        int SetCampaignParameters(string tenantId, long campaignId, DialingMode dialingMode, bool recordWholeInterview, string surveyParametersXml);
