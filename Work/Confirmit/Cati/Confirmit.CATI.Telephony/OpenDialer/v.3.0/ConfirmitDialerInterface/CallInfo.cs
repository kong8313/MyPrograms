    ...
    public class CallInfo
    {
        ...
        public override string ToString()
        {
            return string.Format(
                ...
                "numberOfNoAnswer={10}, isRecording={11},  agingTimeout={12}, dialerSpecificAccompanyInfo=({13})]",
                ...
                numberOfNoAnswer, isRecording, agingTimeout, dialerSpecificAccompanyInfo);
        }
    }
}
