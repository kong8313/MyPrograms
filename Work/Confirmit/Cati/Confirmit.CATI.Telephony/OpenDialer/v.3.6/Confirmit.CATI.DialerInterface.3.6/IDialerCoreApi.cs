...
namespace ConfirmitDialerInterface
{
    ...
    public interface IDialerCoreApi
    {
        ...
        /// Other DialerErrorCode if failed
        /// </returns>
        DialerErrorCode CompleteCall(int companyId, int dialerId, long campaignId, int agentId, InterviewStatus interviewStatus, bool makeAgentReady, string breakName);

        /// <summary>
        /// Finishes current interview and switches to the next interview, keeping existing connection on dialer
        /// </summary>
        /// <param name="companyId">Confirmit company id</param>
        /// <param name="dialerId">Id of the target dialer</param>
        /// <param name="currentCampaignId">The unique identifier of the current campaign.</param>
        /// <param name="agentId">The unique identifier of the agent.</param>
        /// <param name="currentInterviewStatus">The interview status, see ConfirmitDialerInterface.InterviewStatus class for details.</param>
        ...
        /// before dropping the call or null if no audio should be played</param>
        ...
        /// If (targetType==AgentGroup) dialer should take an agent that belongs to the group specified in the targetResource parameter
        /// If (targetType==AgentGroup) AND (targetResource==null) dialer should take any agent logged into the campaign specified in the campaignId parameter
        /// If borrowAgentsFromAllCampaigns is true dialer can take agents logged in to any campaign, otherwise only agents logged in the campaign specified in campaignId parameter
        /// </summary>
        /// <param name="companyId"></param>
        /// <param name="dialerId"></param>
        /// <param name="campaignId"></param>
