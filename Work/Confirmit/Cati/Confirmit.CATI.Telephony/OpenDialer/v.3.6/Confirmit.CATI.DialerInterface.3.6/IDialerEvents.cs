...
namespace ConfirmitDialerInterface
{
    ...
    public interface IDialerEvents
    {
        ...
        /// <summary>
        /// Notifies Confirmit CATI about a new inbound call.
        /// </summary>
        /// <param name="companyId">Confirmit company id</param>
        /// <param name="dialerId">Dialer id</param>
        ...
        /// <summary>
        /// Notifies Confirmit CATI that call is dropped by respondent.
        /// </summary>
        /// <param name="companyId">Confirmit company id</param>
        /// <param name="dialerId">Dialer id</param>
        /// <param name="campaignId">The unique identifier of the Campaign.</param>
        ...
        /// <summary>
        /// Notifies Confirmit CATI that inbound call is dropped by respondent.
        /// </summary>
        /// <param name="companyId">Confirmit company id</param>
        /// <param name="dialerId">Dialer id</param>
        /// <param name="inboundCallId">The unique identifier of the inbound call id (generated by dialer)</param>
        ...
        /// <summary>
        /// Notifies Confirmit CATI about IVR form submission.
        /// </summary>
        /// <param name="companyId">Confirmit company id</param>
        /// <param name="dialerId">Dialer id</param>
        /// <param name="campaignId">The unique identifier of the Campaign.</param>
        ...
        /// <summary>
        /// Notifies Confirmit CATI about current transfer session state.
