...
namespace Confirmit.CATI.Telephony
{
    ...
    public interface IDialerAPI
    {
        ...
        int CompleteCall(string tenantId, long campaignId, string agentId, InterviewStatus interviewStatus, bool makeAgentReady, string breakName);
