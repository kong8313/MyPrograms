...
namespace Confirmit.CATI.Telephony.DialerService.Contract
{
    ...
    public interface IDialerServiceCore
    {
        ...
        /// Forsta CATI will not call any other methods after Release.
        /// Note: actually some methods can still be called, see 'Workflow' chapter of 'Forsta Open Dialer Interface' document for details.
        /// </summary>
        ...
        [FaultContract(typeof(DialerWsInvalidCredentialsExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        DialerFeatures GetFeatures(int companyId, int dialerId);
        ...
        /// If dialer returns DialerState.Unavailable or GetState call fails then Forsta CATI tries to call GetState again and again during appropriate time.
        /// If GetState calls still return DialerState.Unavailable then Forsta CATI makes dialer unavailable and finally calls IDialercoreApi.Release.
        /// Dialer can also use IDialerEvents.NotifyDialerState to notify Forsta CATI about dialer state change. 
        /// </summary>
        /// <param name="companyId">Forsta company id</param>
        ...
        [FaultContract(typeof(DialerParametersExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        DialerErrorCode StartCampaign(int companyId, int[] dialerIds, long campaignId, string campaignName,
        ...
        [FaultContract(typeof(DialerParametersExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        DialerErrorCode SetCampaignParameters(int companyId, int[] dialerIds, long campaignId, DialingMode dialingMode,
            bool recordWholeInterview, string campaignParametersXml);

        /// <summary>
        /// Login agent to dialer.
        /// Dialer informs Forsta CATI about the agent login result via IDialerEvents.NotifyAgentState event (if agent is not already logged in to dialer).
        /// </summary>
        /// <param name="companyId">Forsta company id</param>
        /// <param name="dialerId">Dialer id who perform the operation</param>
        /// <param name="campaignId">
        ///     The campaign unique identifier.
        ///     Forsta CATI can pass campaignId=0. This means that agent will be logged in not to a concrete campaign and can work with many campaigns during one login session.
        ...
        /// Dialer informs Forsta CATI about the dial result via IDialerEvents.NotifyOutcome event for each call.
        /// </summary>
        ...
        /// <summary>
        /// Notifies the dialer of a transition to a subsequent interview within the same respondent phone call for linked interviews in CATI.
        /// This method alerts the dialer that the agent has completed the current interview and has begun another
        /// on the CATI system without terminating the existing telephone connection with the respondent.
        /// <list type="bullet">
        /// <item> <description>The concept of linked interviews allows an agent to conduct multiple interviews consecutively within a single phone call.</description> </item>
        /// <item> <description>Upon receiving this notification, the dialer should update its records to reflect that the active phone connection
        /// is now associated with the new interview identifiers: <paramref name="nextCallId"/>, <paramref name="nextInterviewId"/>, and <paramref name="nextCampaignId"/>.</description> </item>
        /// <item> <description>The existing telephone connection remains active, with the actual transition between interviews being managed by the CATI system.</description> </item>
        /// <item> <description>The dialer is expected to treat the continuation of the call as a new respondent interaction for data logging and call recording purposes.</description> </item>
        /// <item> <description>The <paramref name="nextCallId"/> is assumed not to be in the dialer's call queue.</description> </item>
        /// <item> <description>This notification does not imply that the agent is reassigned to a different campaign; it solely updates the call context.</description> </item>
        /// </list>
        /// </summary>
        /// <param name="companyId">Forsta company id.</param>
        /// <param name="dialerId">Id of the target dialer.</param>
        /// <param name="currentCampaignId">The unique identifier of the campaign for the completed interview.</param>
        /// <param name="agentId">The unique identifier of the agent.</param>
        /// <param name="currentInterviewStatus">The status of the completed interview. See <see cref="ConfirmitDialerInterface.InterviewStatus"/> for details.</param>
        /// <param name="nextCampaignId">The unique identifier of the campaign for the new interview.</param>
        /// <param name="nextInterviewId">The unique identifier of the new interview being started within the same phone call.</param>
        /// <param name="nextCallId">The unique identifier of the next call segment within the ongoing telephone connection.</param>
        /// <returns>
        ...
        /// <param name="interviewId">The unique identifier of the interview</param>
        /// <param name="callId">The unique identifier of the call</param>
        /// <param name="respondentSurveyLink">URL link to th respondent survey</param>
        /// <returns></returns>
        [OperationContract]
        [FaultContract(typeof(DialerWsInvalidCredentialsExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        ...
        /// Dialer informs Forsta CATI about the operation result via IDialerEvents.NotifyOutcome event.
        ...
        [FaultContract(typeof(DialerWsInvalidCredentialsExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        DialerErrorCode GetTrunkLineStatesAndAlarms(int companyId, int dialerId,
            out IEnumerable<TrunkLineStateAndAlarms> trunkLineStatesAndAlarms);
        ...
        [FaultContract(typeof(DialerWsInvalidCredentialsExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        DialerErrorCode ConnectInboundCall(
            int companyId,
            int dialerId,
            long campaignId,
            string inboundCallId,
        ...
        /// <param name="dialerId"></param>
        /// <param name="campaignId"></param>
        /// <param name="transferId">A GUID based unique ID</param>
        /// <param name="agentId"></param>
        ...
        /// <summary>
        /// This should include the target, specified by type and targetResource, into the transfer session.
        /// The actual behaviour will depend on a target type.
        /// For TargetType.External this should start calling a telephone number specified in targetResource and connect it to the transfer.
        /// For TargetType.Agent this should connect an agent (with ID specified in targetResource) to the transfer.
        /// For TargetType.AgentGroup this should find an available agent in the group (group ID specified in targetResource) and connect it to the transfer session.
        /// </summary>
        /// <param name="companyId"></param>
        /// <param name="dialerId"></param>
        /// <param name="campaignId"></param>
        ...
        /// <param name="borrowAgentsFromAllCampaigns"></param>
        /// <returns></returns>
        [OperationContract]
        [FaultContract(typeof(DialerWsInvalidCredentialsExceptionDetails))]
        [FaultContract(typeof(DialerExceptionDetail))]
        ...
        /// <summary>
        /// Connects 2 out of 3 sides of transfer according to specified parameter.
        ...
        /// Following CompleteCall() calls should not affect respondent after TransferStart()
        /// CompleteCall may be called before or after the TransferComplete
        /// </summary>
        /// <param name="companyId"></param>
        /// <param name="dialerId"></param>
        /// <param name="campaignId"></param>
