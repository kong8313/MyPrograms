...
namespace Confirmit.CATI.Telephony
{
    public class Logger : ICommonLogger
    {
        ...
        private TextToLogFileTraceListener Listener => _traceSource.Listeners.OfType<TextToLogFileTraceListener>().FirstOrDefault();
        public string LoggingFileName => Listener?.LoggingFileName;
        public string LoggingPath => Listener?.LoggingPath;
