...
{
    public class DialerAuthorizationKeyEncryptor : CatiSymmetricEncryptor, IDialerAuthorizationKeyEncryptor
    {
        //private const string AuthorizationKey = "{1FD74359-A908-4743-AFF1-4A58979CC6F7}";

        private readonly byte[] _authorizationKey = new byte[32] {
