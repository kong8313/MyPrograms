...
namespace Confirmit.CATI.Telephony.DialerCommon
{
    ...
    public interface IDialerEventsHandlerService
    {
        ...
        [OperationContract]
        void NotifyCustomIvrInterviewEnd(int dialerId, int companyId, long campaignId,
        ...
        [OperationContract]
        void NotifyTransferState(int dialerId, int companyId, string transferId, TransferState transferState);
    }
}