namespace ConfirmitDialerInterface
{
    ...
    public class InterviewStatus
    {
        ...
        /// <summary>
        /// Returns new InterviewStatus structure for given outcome.
        /// </summary>
        public static InterviewStatus FromCallOutcome(CallOutcome outcome)
        {
            return new InterviewStatus() {Code = (int)outcome, Name = outcome.ToString()};
        }
    }
}
