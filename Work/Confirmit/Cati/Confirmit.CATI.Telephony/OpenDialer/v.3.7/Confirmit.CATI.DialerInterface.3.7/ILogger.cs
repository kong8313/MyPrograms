...
{
    /// <summary>
    /// Dialer writes trace messages to Forsta CATI log via this interface.
    /// </summary>
    public interface ILogger
    {
        /// <summary>
        /// Write a trace message to Forsta CATI log.
        /// </summary>
        ...
        /// <summary>
        /// Write an error message to Forsta CATI log.
        /// </summary>
        ...
        /// <summary>
        /// Write an error message to Forsta CATI log using the message delegate function.
        ...
        /// <summary>
        /// Write a warning message to Forsta CATI log.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        /// It's recommended to place class and method name here like "DummyClass.DummyMethod".
        ...
        /// <summary>
        /// Write a warning message to Forsta CATI log using the message delegate function.
        /// The message delegate function allows to create more sophisticated log messages.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        ...
        /// <summary>
        /// Write an information message to Forsta CATI log.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        /// It's recommended to place class and method name here like "DummyClass.DummyMethod".
        ...
        /// <summary>
        /// Write an information message to Forsta CATI log using the message delegate function.
        /// The message delegate function allows to create more sophisticated log messages.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        ...
        /// <summary>
        /// Write a verbose (debug) message to Forsta CATI log.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        /// It's recommended to place class and method name here like "DummyClass.DummyMethod".
        ...
        /// <summary>
        /// Write a verbose (debug) message to Forsta CATI log using the message delegate function.
        /// The message delegate function allows to create more sophisticated log messages.
        /// </summary>
        /// <param name="sourceCodeLocation">Reference to the source code.
        /// It is placed at the beginning of the trace message.
        ...
        /// <summary>
        /// Create a new logger in order to write messages to Forsta CATI log with some new source name. 
        /// </summary>
