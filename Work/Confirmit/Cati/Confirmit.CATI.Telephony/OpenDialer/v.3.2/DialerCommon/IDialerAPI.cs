...
namespace Confirmit.CATI.Telephony
{
    public interface IDialerAPI
    {
        int Initialize(
            ...
            IDialerEventsHandler ifaceEventsHandler);
        int Release();
        ...
        int CompleteCall(string tenantId, long campaignId, string agentId, InterviewStatus interviewStatus, bool makeAgentReady);
