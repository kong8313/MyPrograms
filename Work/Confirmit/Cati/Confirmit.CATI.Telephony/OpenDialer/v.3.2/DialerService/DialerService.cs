    ...
    public class DialerService : IDialerService, IDisposable, IDialerEvents
    {
        ...
        public DialerService()
        {
            ...
            catch (Exception ex)
            {
                ...
                try
                {
                    var assembly = Assembly.ReflectionOnlyLoad(Settings.Default.DialerDriverAssemblyName);
        ...
        {
            var argumentsAsString = string.Format(
                "companyId={0}, dialerId={1}, campaignId={2}, agentId={3}, agentName={4}, agentConnectionString={5}, isPredictive={6}, resourceBindingType={7}, agentAttributes={8}",
                companyId, dialerId, campaignId, agentId, agentName, agentConnectionString, isPredictive, resourceBindingType,
            ...
            return Execute(companyId,
                ...
                requestId => DoDialerCall(
                        ...
                        companyId, dialerId, campaignId, agentId, agentName, agentConnectionString, resourceBindingType, isPredictive, agentAttributes),
                    requestId));
        }
            ...
            InterviewStatus interviewStatus)
        {
            ...
            return Execute(companyId,
                ...
                argumentsAsString,
                requestId => DoDialerCall(
                    () => _bridgeToDialer.UpdateInterviewStatus(companyId, dialerId, campaignId, agentId, interviewId, callId, interviewStatus), requestId));
        }
