# Confirmit.CATI.Dialer.AWSConnect
...
## To update Confirmit.CATI.Dialer.AWSConnect when there is a new version of the template

1. Make sure you have committed all you changes in the repo. There should NOT be any pending changes

2. Run the update_from_template script from the Confirmit.CATI.Dialer.AWSConnect directory. This will install the latest version of the MicroService template and update Confirmit.CATI.Dialer.AWSConnect with the latest changes
