...
{
    $CakeBuildTemplateId = "ConfirmitHorizonsApplicationsV190_BuildAndPublishContainerImageWin"
...
{
    $CakeBuildTemplateId = "ConfirmitHorizonsApplicationsV190_ConfirmitCakeDockerBuildWindowsUseManifestListTemplate"
