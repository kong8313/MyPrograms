...
namespace NFakesTestAssembly.Fakes
{
    public class StubITestInterface1<T1, T2, T3, ZZZ> : ITestInterface1<T1, T2, T3, ZZZ> 
    {
        ...
        public delegate void Method22ArrayOfDateTimeDelegate(DateTime[] t1);
        public Method22ArrayOfDateTimeDelegate Method22ArrayOfDateTime;

        void ITestInterface1<T1, T2, T3, ZZZ>.Method22(DateTime[] t1)
        {

            if (Method22ArrayOfDateTime != null)
            {
                Method22ArrayOfDateTime(t1);
            } else if (_inner != null)
            {
        ...
        public delegate void Method16ArrayOfInt32OutDelegate(out int[] t1);
        public Method16ArrayOfInt32OutDelegate Method16ArrayOfInt32Out;

        void ITestInterface1<T1, T2, T3, ZZZ>.Method16(out int[] t1)
        {
            t1 = default(int[]);

            if (Method16ArrayOfInt32Out != null)
            {
                Method16ArrayOfInt32Out(out t1);
            } else if (_inner != null)
            {
        ...
        public delegate void Method15ArrayOfInt32Delegate(int[] t1);
        public Method15ArrayOfInt32Delegate Method15ArrayOfInt32;

        void ITestInterface1<T1, T2, T3, ZZZ>.Method15(int[] t1)
        {

            if (Method15ArrayOfInt32 != null)
            {
                Method15ArrayOfInt32(t1);
            } else if (_inner != null)
            {
