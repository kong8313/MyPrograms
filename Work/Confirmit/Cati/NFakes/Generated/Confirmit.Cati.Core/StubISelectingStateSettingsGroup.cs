...
{
    public class StubISelectingStateSettingsGroup : ISelectingStateSettingsGroup 
    {
        private ISelectingStateSettingsGroup _inner;

        public StubISelectingStateSettingsGroup()
        {
            _inner = null;
        }

        public ISelectingStateSettingsGroup Inner
        {
        ...
        string ISelectingStateSettings.ExcludedInterviewerGroups
        {
            get
            {
                ...
                {
                    return ((ISelectingStateSettings)_inner).ExcludedInterviewerGroups;
                }
            ...
            set
            {
                ...
                {
                    ((ISelectingStateSettings)_inner).ExcludedInterviewerGroups = value;
                    return;
                }
        ...
        bool ISelectingStateSettings.IsAlertEnabled
        {
            get
            {
                ...
                {
                    return ((ISelectingStateSettings)_inner).IsAlertEnabled;
                }
            ...
            set
            {
                ...
                {
                    ((ISelectingStateSettings)_inner).IsAlertEnabled = value;
                    return;
                }
        ...
        TimeSpan ISelectingStateSettings.NotificationFrequency
        {
            get
            {
                ...
                {
                    return ((ISelectingStateSettings)_inner).NotificationFrequency;
                }
            ...
            set
            {
                ...
                {
                    ((ISelectingStateSettings)_inner).NotificationFrequency = value;
                    return;
                }
        ...
        int ISelectingStateSettings.NumberOfInterviewers
        {
            get
            {
                ...
                {
                    return ((ISelectingStateSettings)_inner).NumberOfInterviewers;
                }
            ...
            set
            {
                ...
                {
                    ((ISelectingStateSettings)_inner).NumberOfInterviewers = value;
                    return;
                }
        ...
        int ISelectingStateSettings.NumberOfMinutes
        {
            get
            {
                ...
                {
                    return ((ISelectingStateSettings)_inner).NumberOfMinutes;
                }
            ...
            set
            {
                ...
                {
                    ((ISelectingStateSettings)_inner).NumberOfMinutes = value;
                    return;
                }
