...
{
    public class StubIRetryingServiceSettingsGroup : IRetryingServiceSettingsGroup 
    {
        private IRetryingServiceSettingsGroup _inner;

        public StubIRetryingServiceSettingsGroup()
        {
            _inner = null;
        }

        public IRetryingServiceSettingsGroup Inner
        {
