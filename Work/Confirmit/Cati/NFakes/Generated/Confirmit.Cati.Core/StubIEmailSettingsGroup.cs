...
{
    public class StubIEmailSettingsGroup : IEmailSettingsGroup 
    {
        private IEmailSettingsGroup _inner;

        public StubIEmailSettingsGroup()
        {
            _inner = null;
        }

        public IEmailSettingsGroup Inner
        {
