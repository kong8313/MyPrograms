...
{
    public class StubISurveyCleanupSettingsGroup : ISurveyCleanupSettingsGroup 
    {
        private ISurveyCleanupSettingsGroup _inner;

        public StubISurveyCleanupSettingsGroup()
        {
            _inner = null;
        }

        public ISurveyCleanupSettingsGroup Inner
        {
