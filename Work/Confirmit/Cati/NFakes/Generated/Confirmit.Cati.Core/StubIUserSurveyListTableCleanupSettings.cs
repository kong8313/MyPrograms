...
{
    public class StubIUserSurveyListTableCleanupSettings : IUserSurveyListTableCleanupSettings 
    {
        private IUserSurveyListTableCleanupSettings _inner;

        public StubIUserSurveyListTableCleanupSettings()
        {
            _inner = null;
        }

        public IUserSurveyListTableCleanupSettings Inner
        {
