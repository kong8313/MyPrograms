...
{
    public class StubIWebServiceUrlSettingsGroup : IWebServiceUrlSettingsGroup 
    {
        private IWebServiceUrlSettingsGroup _inner;

        public StubIWebServiceUrlSettingsGroup()
        {
            _inner = null;
        }

        public IWebServiceUrlSettingsGroup Inner
        {
