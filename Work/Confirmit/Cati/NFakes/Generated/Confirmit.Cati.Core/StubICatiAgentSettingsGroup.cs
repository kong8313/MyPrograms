...
{
    public class StubICatiAgentSettingsGroup : ICatiAgentSettingsGroup 
    {
        private ICatiAgentSettingsGroup _inner;

        public StubICatiAgentSettingsGroup()
        {
            _inner = null;
        }

        public ICatiAgentSettingsGroup Inner
        {
