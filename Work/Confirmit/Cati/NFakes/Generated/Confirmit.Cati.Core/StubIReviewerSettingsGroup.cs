...
{
    public class StubIReviewerSettingsGroup : IReviewerSettingsGroup 
    {
        private IReviewerSettingsGroup _inner;

        public StubIReviewerSettingsGroup()
        {
            _inner = null;
        }

        public IReviewerSettingsGroup Inner
        {
