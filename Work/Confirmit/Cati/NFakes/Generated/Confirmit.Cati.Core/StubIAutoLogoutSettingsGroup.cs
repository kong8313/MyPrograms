...
{
    public class StubIAutoLogoutSettingsGroup : IAutoLogoutSettingsGroup 
    {
        private IAutoLogoutSettingsGroup _inner;

        public StubIAutoLogoutSettingsGroup()
        {
            _inner = null;
        }

        public IAutoLogoutSettingsGroup Inner
        {
