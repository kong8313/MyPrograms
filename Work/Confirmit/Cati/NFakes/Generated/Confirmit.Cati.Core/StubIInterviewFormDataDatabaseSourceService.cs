...
{
    public class StubIInterviewFormDataDatabaseSourceService : IInterviewFormDataDatabaseSourceService 
    {
        private IInterviewFormDataDatabaseSourceService _inner;

        public StubIInterviewFormDataDatabaseSourceService()
        {
            _inner = null;
        }

        public IInterviewFormDataDatabaseSourceService Inner
        {
        ...
        string IInterviewFormDataDatabaseSourceService.GetDiff()
        {
            ...
            {
                return ((IInterviewFormDataDatabaseSourceService)_inner).GetDiff();
            }
