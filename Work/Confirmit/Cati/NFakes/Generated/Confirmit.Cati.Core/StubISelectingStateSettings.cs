...
{
    public class StubISelectingStateSettings : ISelectingStateSettings 
    {
        private ISelectingStateSettings _inner;

        public StubISelectingStateSettings()
        {
            _inner = null;
        }

        public ISelectingStateSettings Inner
        {
