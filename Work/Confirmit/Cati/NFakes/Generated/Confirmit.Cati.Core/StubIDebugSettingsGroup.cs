...
{
    public class StubIDebugSettingsGroup : IDebugSettingsGroup 
    {
        private IDebugSettingsGroup _inner;

        public StubIDebugSettingsGroup()
        {
            _inner = null;
        }

        public IDebugSettingsGroup Inner
        {
