...
{
    public class StubIMonitoringSettingsGroup : IMonitoringSettingsGroup 
    {
        private IMonitoringSettingsGroup _inner;

        public StubIMonitoringSettingsGroup()
        {
            _inner = null;
        }

        public IMonitoringSettingsGroup Inner
        {
