...
{
    public class StubIAsyncOperationSchedulerThread : IAsyncOperationSchedulerThread 
    {
        private IAsyncOperationSchedulerThread _inner;

        public StubIAsyncOperationSchedulerThread()
        {
            _inner = null;
        }

        public IAsyncOperationSchedulerThread Inner
        {
        ...
        public delegate void PollAndStartAsyncOperationsDelegate();
        public PollAndStartAsyncOperationsDelegate PollAndStartAsyncOperations;

        void IAsyncOperationSchedulerThread.PollAndStartAsyncOperations()
        {

            if (PollAndStartAsyncOperations != null)
            {
                PollAndStartAsyncOperations();
            } else if (_inner != null)
            {
                ((IAsyncOperationSchedulerThread)_inner).PollAndStartAsyncOperations();
            }
        }
