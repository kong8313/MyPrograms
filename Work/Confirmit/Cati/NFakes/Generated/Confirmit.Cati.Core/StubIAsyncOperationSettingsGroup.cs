...
{
    public class StubIAsyncOperationSettingsGroup : IAsyncOperationSettingsGroup 
    {
        private IAsyncOperationSettingsGroup _inner;

        public StubIAsyncOperationSettingsGroup()
        {
            _inner = null;
        }

        public IAsyncOperationSettingsGroup Inner
        {
