...
{
    public class StubISetupSettingsGroup : ISetupSettingsGroup 
    {
        private ISetupSettingsGroup _inner;

        public StubISetupSettingsGroup()
        {
            _inner = null;
        }

        public ISetupSettingsGroup Inner
        {
