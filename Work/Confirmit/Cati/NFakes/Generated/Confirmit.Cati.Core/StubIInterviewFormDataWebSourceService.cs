...
{
    public class StubIInterviewFormDataWebSourceService : IInterviewFormDataWebSourceService 
    {
        private IInterviewFormDataWebSourceService _inner;

        public StubIInterviewFormDataWebSourceService()
        {
            _inner = null;
        }

        public IInterviewFormDataWebSourceService Inner
        {
