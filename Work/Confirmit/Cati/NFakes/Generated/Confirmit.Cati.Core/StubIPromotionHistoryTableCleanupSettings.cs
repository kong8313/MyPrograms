...
{
    public class StubIPromotionHistoryTableCleanupSettings : IPromotionHistoryTableCleanupSettings 
    {
        private IPromotionHistoryTableCleanupSettings _inner;

        public StubIPromotionHistoryTableCleanupSettings()
        {
            _inner = null;
        }

        public IPromotionHistoryTableCleanupSettings Inner
        {
