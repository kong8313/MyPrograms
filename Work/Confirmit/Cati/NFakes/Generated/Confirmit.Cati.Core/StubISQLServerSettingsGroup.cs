...
{
    public class StubISQLServerSettingsGroup : ISQLServerSettingsGroup 
    {
        private ISQLServerSettingsGroup _inner;

        public StubISQLServerSettingsGroup()
        {
            _inner = null;
        }

        public ISQLServerSettingsGroup Inner
        {
