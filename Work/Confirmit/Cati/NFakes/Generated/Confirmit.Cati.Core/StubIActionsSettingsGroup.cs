...
{
    public class StubIActionsSettingsGroup : IActionsSettingsGroup 
    {
        private IActionsSettingsGroup _inner;

        public StubIActionsSettingsGroup()
        {
            _inner = null;
        }

        public IActionsSettingsGroup Inner
        {
