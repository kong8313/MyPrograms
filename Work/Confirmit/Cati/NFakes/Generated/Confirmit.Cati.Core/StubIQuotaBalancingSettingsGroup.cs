...
{
    public class StubIQuotaBalancingSettingsGroup : IQuotaBalancingSettingsGroup 
    {
        private IQuotaBalancingSettingsGroup _inner;

        public StubIQuotaBalancingSettingsGroup()
        {
            _inner = null;
        }

        public IQuotaBalancingSettingsGroup Inner
        {
