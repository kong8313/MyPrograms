...
{
    public class StubICallManagementSettings : ICallManagementSettings 
    {
        private ICallManagementSettings _inner;

        public StubICallManagementSettings()
        {
            _inner = null;
        }

        public ICallManagementSettings Inner
        {
