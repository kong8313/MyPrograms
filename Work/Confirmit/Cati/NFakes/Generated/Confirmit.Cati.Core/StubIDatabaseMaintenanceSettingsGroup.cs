...
{
    public class StubIDatabaseMaintenanceSettingsGroup : IDatabaseMaintenanceSettingsGroup 
    {
        private IDatabaseMaintenanceSettingsGroup _inner;

        public StubIDatabaseMaintenanceSettingsGroup()
        {
            _inner = null;
        }

        public IDatabaseMaintenanceSettingsGroup Inner
        {
