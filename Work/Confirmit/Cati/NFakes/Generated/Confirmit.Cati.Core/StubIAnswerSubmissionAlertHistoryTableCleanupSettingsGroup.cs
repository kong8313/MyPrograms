...
{
    public class StubIAnswerSubmissionAlertHistoryTableCleanupSettingsGroup : IAnswerSubmissionAlertHistoryTableCleanupSettingsGroup 
    {
        private IAnswerSubmissionAlertHistoryTableCleanupSettingsGroup _inner;

        public StubIAnswerSubmissionAlertHistoryTableCleanupSettingsGroup()
        {
            _inner = null;
        }

        public IAnswerSubmissionAlertHistoryTableCleanupSettingsGroup Inner
        {
