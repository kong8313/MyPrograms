...
namespace Confirmit.CATI.Core.Threading.Fakes
{
    public class StubIPeriodicalThread : IPeriodicalThread 
    {
        private IPeriodicalThread _inner;

        public StubIPeriodicalThread()
        {
            _inner = null;
        }

        public IPeriodicalThread Inner
        {
