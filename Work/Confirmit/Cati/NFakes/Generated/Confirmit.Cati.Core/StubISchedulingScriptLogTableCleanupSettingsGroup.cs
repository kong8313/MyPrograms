...
{
    public class StubISchedulingScriptLogTableCleanupSettingsGroup : ISchedulingScriptLogTableCleanupSettingsGroup 
    {
        private ISchedulingScriptLogTableCleanupSettingsGroup _inner;

        public StubISchedulingScriptLogTableCleanupSettingsGroup()
        {
            _inner = null;
        }

        public ISchedulingScriptLogTableCleanupSettingsGroup Inner
        {
