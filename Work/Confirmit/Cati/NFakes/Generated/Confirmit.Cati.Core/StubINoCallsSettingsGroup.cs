...
{
    public class StubINoCallsSettingsGroup : INoCallsSettingsGroup 
    {
        private INoCallsSettingsGroup _inner;

        public StubINoCallsSettingsGroup()
        {
            _inner = null;
        }

        public INoCallsSettingsGroup Inner
        {
        ...
        string INoCallsSettings.ExcludedInterviewerGroups
        {
            get
            {
                ...
                {
                    return ((INoCallsSettings)_inner).ExcludedInterviewerGroups;
                }
            ...
            set
            {
                ...
                {
                    ((INoCallsSettings)_inner).ExcludedInterviewerGroups = value;
                    return;
                }
        ...
        bool INoCallsSettings.IsAlertEnabled
        {
            get
            {
                ...
                {
                    return ((INoCallsSettings)_inner).IsAlertEnabled;
                }
            ...
            set
            {
                ...
                {
                    ((INoCallsSettings)_inner).IsAlertEnabled = value;
                    return;
                }
        ...
        TimeSpan INoCallsSettings.NotificationFrequency
        {
            get
            {
                ...
                {
                    return ((INoCallsSettings)_inner).NotificationFrequency;
                }
            ...
            set
            {
                ...
                {
                    ((INoCallsSettings)_inner).NotificationFrequency = value;
                    return;
                }
        ...
        int INoCallsSettings.NumberOfInterviewers
        {
            get
            {
                ...
                {
                    return ((INoCallsSettings)_inner).NumberOfInterviewers;
                }
            ...
            set
            {
                ...
                {
                    ((INoCallsSettings)_inner).NumberOfInterviewers = value;
                    return;
                }
        ...
        int INoCallsSettings.NumberOfMinutes
        {
            get
            {
                ...
                {
                    return ((INoCallsSettings)_inner).NumberOfMinutes;
                }
            ...
            set
            {
                ...
                {
                    ((INoCallsSettings)_inner).NumberOfMinutes = value;
                    return;
                }
