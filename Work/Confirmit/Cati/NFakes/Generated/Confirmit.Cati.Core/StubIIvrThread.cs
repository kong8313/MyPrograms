...
namespace Confirmit.CATI.Backend.Threads.Fakes
{
    public class StubIIvrThread : IIvrThread 
    {
        private IIvrThread _inner;

        public StubIIvrThread()
        {
            _inner = null;
        }

        public IIvrThread Inner
        {
