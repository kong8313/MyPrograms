...
{
    public class StubISchedulingErrorsSettings : ISchedulingErrorsSettings 
    {
        private ISchedulingErrorsSettings _inner;

        public StubISchedulingErrorsSettings()
        {
            _inner = null;
        }

        public ISchedulingErrorsSettings Inner
        {
