...
{
    public class StubIAlertingSettingsGroup : IAlertingSettingsGroup 
    {
        private IAlertingSettingsGroup _inner;

        public StubIAlertingSettingsGroup()
        {
            _inner = null;
        }

        public IAlertingSettingsGroup Inner
        {
