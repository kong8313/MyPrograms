...
{
    public class StubIPersonDeferredMonitoringTableCleanupSettingsGroup : IPersonDeferredMonitoringTableCleanupSettingsGroup 
    {
        private IPersonDeferredMonitoringTableCleanupSettingsGroup _inner;

        public StubIPersonDeferredMonitoringTableCleanupSettingsGroup()
        {
            _inner = null;
        }

        public IPersonDeferredMonitoringTableCleanupSettingsGroup Inner
        {
