...
{
    public class StubIWaitingStateSettingsGroup : IWaitingStateSettingsGroup 
    {
        private IWaitingStateSettingsGroup _inner;

        public StubIWaitingStateSettingsGroup()
        {
            _inner = null;
        }

        public IWaitingStateSettingsGroup Inner
        {
