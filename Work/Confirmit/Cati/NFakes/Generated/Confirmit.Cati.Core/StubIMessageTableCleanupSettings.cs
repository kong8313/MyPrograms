...
{
    public class StubIMessageTableCleanupSettings : IMessageTableCleanupSettings 
    {
        private IMessageTableCleanupSettings _inner;

        public StubIMessageTableCleanupSettings()
        {
            _inner = null;
        }

        public IMessageTableCleanupSettings Inner
        {
