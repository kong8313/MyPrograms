...
{
    public class StubIServiceBrokerObjectsCleanupSettingsGroup : IServiceBrokerObjectsCleanupSettingsGroup 
    {
        private IServiceBrokerObjectsCleanupSettingsGroup _inner;

        public StubIServiceBrokerObjectsCleanupSettingsGroup()
        {
            _inner = null;
        }

        public IServiceBrokerObjectsCleanupSettingsGroup Inner
        {
        ...
        TimeSpan IServiceBrokerObjectsCleanupSettings.ExpirationPeriod
        {
            get
            {
                ...
                {
                    return ((IServiceBrokerObjectsCleanupSettings)_inner).ExpirationPeriod;
                }
            ...
            set
            {
                ...
                {
                    ((IServiceBrokerObjectsCleanupSettings)_inner).ExpirationPeriod = value;
                    return;
                }
        ...
        int IServiceBrokerObjectsCleanupSettings.ShiftType
        {
            get
            {
                ...
                {
                    return ((IServiceBrokerObjectsCleanupSettings)_inner).ShiftType;
                }
            ...
            set
            {
                ...
                {
                    ((IServiceBrokerObjectsCleanupSettings)_inner).ShiftType = value;
                    return;
                }
