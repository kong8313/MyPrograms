...
{
    public class StubIRoutineMaintenanceSettingsGroup : IRoutineMaintenanceSettingsGroup 
    {
        private IRoutineMaintenanceSettingsGroup _inner;

        public StubIRoutineMaintenanceSettingsGroup()
        {
            _inner = null;
        }

        public IRoutineMaintenanceSettingsGroup Inner
        {
