...
{
    public class StubISchedulingScriptSettings : ISchedulingScriptSettings 
    {
        private ISchedulingScriptSettings _inner;

        public StubISchedulingScriptSettings()
        {
            _inner = null;
        }

        public ISchedulingScriptSettings Inner
        {
