...
{
    public class StubISecuritySettingsGroup : ISecuritySettingsGroup 
    {
        private ISecuritySettingsGroup _inner;

        public StubISecuritySettingsGroup()
        {
            _inner = null;
        }

        public ISecuritySettingsGroup Inner
        {
