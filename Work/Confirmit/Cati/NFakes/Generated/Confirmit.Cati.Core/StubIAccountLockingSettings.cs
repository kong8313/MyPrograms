...
{
    public class StubIAccountLockingSettings : IAccountLockingSettings 
    {
        private IAccountLockingSettings _inner;

        public StubIAccountLockingSettings()
        {
            _inner = null;
        }

        public IAccountLockingSettings Inner
        {
