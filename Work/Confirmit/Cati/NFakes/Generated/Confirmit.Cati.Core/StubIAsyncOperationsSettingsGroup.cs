...
{
    public class StubIAsyncOperationsSettingsGroup : IAsyncOperationsSettingsGroup 
    {
        private IAsyncOperationsSettingsGroup _inner;

        public StubIAsyncOperationsSettingsGroup()
        {
            _inner = null;
        }

        public IAsyncOperationsSettingsGroup Inner
        {
