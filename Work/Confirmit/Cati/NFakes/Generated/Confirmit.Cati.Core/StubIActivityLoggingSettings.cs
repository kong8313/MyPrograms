...
{
    public class StubIActivityLoggingSettings : IActivityLoggingSettings 
    {
        private IActivityLoggingSettings _inner;

        public StubIActivityLoggingSettings()
        {
            _inner = null;
        }

        public IActivityLoggingSettings Inner
        {
