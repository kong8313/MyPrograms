...
{
    public class StubICallHistoryHubSettingsGroup : ICallHistoryHubSettingsGroup 
    {
        private ICallHistoryHubSettingsGroup _inner;

        public StubICallHistoryHubSettingsGroup()
        {
            _inner = null;
        }

        public ICallHistoryHubSettingsGroup Inner
        {
