...
{
    public class StubISurveysSettingsGroup : ISurveysSettingsGroup 
    {
        private ISurveysSettingsGroup _inner;

        public StubISurveysSettingsGroup()
        {
            _inner = null;
        }

        public ISurveysSettingsGroup Inner
        {
