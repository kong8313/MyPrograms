...
{
    public class StubIInterviewerPasswordSettings : IInterviewerPasswordSettings 
    {
        private IInterviewerPasswordSettings _inner;

        public StubIInterviewerPasswordSettings()
        {
            _inner = null;
        }

        public IInterviewerPasswordSettings Inner
        {
