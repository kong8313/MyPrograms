...
{
    public class StubIServerSettingsGroup : IServerSettingsGroup 
    {
        private IServerSettingsGroup _inner;

        public StubIServerSettingsGroup()
        {
            _inner = null;
        }

        public IServerSettingsGroup Inner
        {
