...
{
    public class StubIAsyncOperationQueueTableCleanupSettingsGroup : IAsyncOperationQueueTableCleanupSettingsGroup 
    {
        private IAsyncOperationQueueTableCleanupSettingsGroup _inner;

        public StubIAsyncOperationQueueTableCleanupSettingsGroup()
        {
            _inner = null;
        }

        public IAsyncOperationQueueTableCleanupSettingsGroup Inner
        {
