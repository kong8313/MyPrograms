...
{
    public class StubIDialerSettingsGroup : IDialerSettingsGroup 
    {
        private IDialerSettingsGroup _inner;

        public StubIDialerSettingsGroup()
        {
            _inner = null;
        }

        public IDialerSettingsGroup Inner
        {
