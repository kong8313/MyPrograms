...
{
    /// <summary>
    /// Base exception class for all custom CATI-related exceptions.
    /// </summary>
    [Serializable]
    public class CatiException : Exception
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CatiException"/> class.
        /// </summary>
        public CatiException()
        {
        }
        ...
        public CatiException(string message)
            : base(message)
        {
        }
        ...
        public CatiException(string message, Exception innerException)
        ...
        /// </exception>
        protected CatiException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
