...
namespace Confirmit.CATI.Common.Exceptions
{
    ...
    /// </summary>
    public class NotSupportedOsException : UserMessageException
    {
         /// <summary>
        ...
        public NotSupportedOsException(string message, Exception innerException)
        ...
        /// </exception>
        protected NotSupportedOsException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        {
            return new FaultException<NotSupportedOsExceptionDetails>(
                new NotSupportedOsExceptionDetails { Message = Message },
                Message);
        }
    }
    ...
    /// </summary>
    public class NotSupportedOsExceptionDetails : UserMessageExceptionDetails
    {
        /// <summary>
        ...
        {
            return new NotSupportedOsException(Message);
        }
    }
}