        ...
        public void SaveMkbs()
        {
            ...
            foreach (MkbClass mkbInfo in _mkbList)
            {
                mkbsStr.Append(
                    ...
                    "Name=" + mkbInfo.MkbName + DataSplitStr +
                    "KsgCode=" + mkbInfo.KsgCode + DataSplitStr +
                    "KsgName=" + mkbInfo.KsgName + ObjSplitStr);
            }
                ...
                foreach (string dataStr in datasStr)
                {
                    ...
                    switch (keyValue[0])
                    {
                        ...
                        case "Name":
                            ...
                            break;
                        case "KsgCode":
                            mkbInfo.KsgCode = keyValue[1];
                            break;
                        case "KsgName":
                            mkbInfo.KsgName = keyValue[1];
                            break;
                    }
                }
